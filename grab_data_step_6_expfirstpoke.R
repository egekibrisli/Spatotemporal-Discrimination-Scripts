...
write.table(dat, '/Users/PC/Dropbox/eloras_rats/data/denemestep6/dat_step6expp.csv')
...
dat <- read.table('/Users/PC/Dropbox/eloras_rats/data/denemestep6/dat_step6expp.csv')
...
write.table(all_data, 'C:/Users/PC/Dropbox/eloras_rats/data/denemestep6/all_data_step6exp.csv')
...
df <- read.csv("/Users/PC/Dropbox/eloras_rats/data/denemestep6/all_data_step6exp.csv", header = FALSE, col.names = "data")
...
all_data <- subset(read.csv('C:/Users/PC/Dropbox/eloras_rats/data/denemestep6/dnmall_data_step6expcolumned.csv'))
...
write.csv(all_data, 'C:/Users/PC/Dropbox/eloras_rats/data/denemestep6/all_data_step6exp_filtered.csv', row.names = FALSE)
