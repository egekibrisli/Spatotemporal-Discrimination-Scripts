# Read the data
all_data <- read.csv("C:/Users/PC/Dropbox/eloras_rats/data/denemestep6/all_data_step6exp_filtered.csv")
...
barplot(counts, beside = TRUE, legend.text = c("SE", "ME"),
        ...
        xlab = "Group", ylab = "Count", main = "First SRNH and MRNH Counts for Normal Durations")